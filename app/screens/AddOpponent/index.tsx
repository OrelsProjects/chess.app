...
const AddOpponent: React.FC = () => {
  ...
  React.useEffect(() => {
    console.log("Selected Options Array:", selectedOptionArray);
  }, [selectedOptionArray]);
    ...
    return (
      <>
        <ScrollView style={{ flex: 1 }}>
          <View style={styles.divider} />
          <Text style={styles.optionText}>{t("selectedOptions")}</Text>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={styles.childContainer}>
          <View style={styles.headerContainer}>
            <Text style={styles.heading}>{t("addOpponents")}</Text>
          </View>
            ...
            {serachApiData.length > 0 ? (
              <View
                style={{
                  ...
                  // maxHeight: hp("70"),
                  width: "100%",
                  maxHeight: normalized.hp("75"),
                  borderRadius: 10,
                  alignSelf: "center",
                  // backgroundColor: "lightgray",
                  paddingBottom: normalized.hp(12),
                }}
              >
                {searchData.length !== 0 ? Keyboard.dismiss() : null}
                <ScrollView style={{ flex: 1 }}>
          ...
          <CustomInput
            editable={opponentName ? false : true}
