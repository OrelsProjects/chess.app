      ...
      <ScrollView
        ...
        <View style={styles.childContainer}>
          ...
          <TouchableOpacity onPress={()=>{
            ...
            <View style={[styles.langButton,selectedLanguage === 'English'?{borderColor: '#007AFF'}:null]}>
          ...
          <TouchableOpacity onPress={()=>{
            ...
            <View style={[styles.langButton,selectedLanguage === 'Hebrew'?{borderColor: '#007AFF'}:null]}>
